...
> = BaseTriggerParams<PieceAuth, TriggerProps, TS> & {
  ...
  onHandshake?: (
    context: TriggerHookContext<PieceAuth, TriggerProps, TS>
...
> implements TriggerBase
{
  constructor(
    ...
    public readonly onHandshake: (
      ctx: TriggerHookContext<PieceAuth, TriggerProps, TS>
    ) => Promise<WebhookResponse>,
    ...
    public readonly run: (
      ctx: TestOrRunHookContext<PieceAuth, TriggerProps, TS>
    ) => Promise<unknown[]>,

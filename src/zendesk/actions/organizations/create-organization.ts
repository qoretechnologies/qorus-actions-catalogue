...
const createOrganization = async (organization: TOrganizationOptions) => {
  try {
    const data: IResponseOrganizationInterface = await zendeskRequest('/organizations', 'POST',organization );
    return data;
  } catch (error) {
